...
const exploreData = [
  ...
  },
  {
    ...
    description: '',
    tags: ['medical', 'health', 'dental', 'vision', 'insurance', 'doctor', 'profile'],
  },
  {
    id: '12',
    title: 'TSP',
  ...
  },
  {
    ...
    cac: true,
    href: 'https://aim.hrc.army.mil/',
    description: 'Active Duty Officer Assignment Interactive Module Version 2.0',
    tags: ['ymav'],
  },
  {
    id: '19',
  ...
  },
  {
    ...
    tags: ['GTC', 'Receipt', 'PCS', 'TDY', 'Voucher', 'Hotel', 'Moving', 'Transportation', 'Move'],
  },
  {
    id: '38',
    title: 'Move.mil',
    ...
    href: 'https://move.mil/',
    description: 'Defense Travel System',
    tags: ['Receipt', 'PCS', 'TDY', 'Voucher', 'Hotel', 'Moving', 'Transportation', 'Move'],
  },
  {
    id: '39',
    title: 'TRiPS',

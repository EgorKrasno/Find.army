...
const Home = () => {
  ...
  const searchFilteredData =
    text.length > 0 ? results.map((result) => result.item) : blocks;
  ...
  return (
    <div className="relative flex flex-col dark:background-dark background-light min-h-screen antialiased font-purista transition ease-in-out overflow-hidden">
      <Image
        style={{
      ...
      <div className="flex-1 mx-6 sm:mx-12">
        <ExploreSearch text={text} setText={setText} />
                ...
                {searchFilteredData.length > 0 ? (
                  ...
                  <div className="flex flex-col items-center justify-center w-full col-span-full">
                    <div className="flex flex-col text-center items-center justify-center space-y-12">
                      <h1 className="text-6xl font-bold">No results found</h1>
                      <div className="relative">
                        <div className="absolute -inset-1 blur dark:bg-yellow-400 bg-sky-700" />
                        <FeedbackButton
                          text="Make a suggestion"
                          style="relative w-64 py-2 text-2xl"
                          openModal={openModal}
                        />
                      </div>
                    </div>

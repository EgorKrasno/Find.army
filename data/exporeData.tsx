...
export const exploreData = [
  {
    id: '1',
    title: 'Army Email',
    icon: <AiOutlineMail className={'dark:text-yellow-300 text-blue-400'} size={iconProps.size} />,
    cac: true,
  ...
  },
  {
    id: '2',
    title: 'MyPay',
    icon: <MdAttachMoney className={'dark:text-yellow-300 text-blue-400'} size={iconProps.size} />,
    cac: false,
  ...
  },
  {
    id: '3',
    title: 'MedPros',
    icon: <GiHealthNormal className={'dark:text-yellow-300 text-blue-400'} size={iconProps.size} />,
    cac: true,
  ...
  },
  {
    ...
    icon: <GiClothes className={'dark:text-yellow-300 text-blue-400'} size={iconProps.size} />,
    cac: true,
  ...
  },
  {
    ...
    icon: <BsFillBriefcaseFill className={'dark:text-yellow-300 text-blue-400'} size={iconProps.size} />,
    cac: true,
  ...
  },
  {
    ...
    icon: <GiComputing className={'dark:text-yellow-300 text-blue-400'} size={iconProps.size} />,
    cac: true,

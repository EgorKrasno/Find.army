          ...
          <div className="flex justify-between items-center w-full">
            <div className="flex items-center">
              <div className="flex items-center space-x-2 sm:space-x-5">
                ...
                <div>
                  <h1 className="dark:text-zinc-50 text-zinc-900 text-2xl sm:text-4xl font-bold tracking-wide">
                    Find.Army
                  </h1>
                  <h2 className="text-xs sm:text-sm dark:text-zinc-200 text-zinc-900 font-semibold">
                    The Better AKO
                  </h2>
                </div>
              </div>
            ...
            <div className="flex items-center space-x-2 sm:space-x-6 ">
              ...
              />
              <a href="https://github.com/EgorKrasno/Find.army" target="_blank">
                <div className="relative">
                  <button className="rounded-sm p-2 ease-in-out cursor-pointer border border-zinc-400 dark:border-zinc-700 shadow dark:shadow-none">
                    <FaGithub size={24} />
                  </button>
                </div>
              </a>
